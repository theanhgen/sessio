...
/// Plain `🗄`, no U+FE0F: with the variation selector terminals disagree on one cell or two, so
/// the columns after it moved from one terminal to the next. Bare, it measures one cell.
